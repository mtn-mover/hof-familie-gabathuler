...
import { ProtectedEmailLink, ProtectedPhoneLink } from './ProtectedContact'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-primary-300 hover:text-secondary-400 transition-colors duration-200">
                <svg
                ...
                <ProtectedPhoneLink className="hover:text-secondary-400" />
              </div>
              <div className="flex items-center gap-3 text-primary-300 hover:text-secondary-400 transition-colors duration-200">
                <svg
                  className="w-5 h-5 text-secondary-500 flex-shrink-0"
                ...
                <ProtectedEmailLink className="hover:text-secondary-400" />
              </div>
            </address>
          </div>
